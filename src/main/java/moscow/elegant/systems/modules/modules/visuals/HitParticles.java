...
public class HitParticles extends BaseModule implements IMinecraft {
   ...
   private final ModeSetting.Value star = new ModeSetting.Value(this.particleType, "modules.settings.hit_particles.particle_type.star").select();
   private final ModeSetting.Value glow = new ModeSetting.Value(this.particleType, "modules.settings.hit_particles.particle_type.glow");
   private final ModeSetting.Value heart = new ModeSetting.Value(this.particleType, "modules.settings.hit_particles.particle_type.heart");
   private final ModeSetting.Value dollar = new ModeSetting.Value(this.particleType, "modules.settings.hit_particles.particle_type.dollar");
   private final ModeSetting.Value starNew = new ModeSetting.Value(this.particleType, "modules.settings.hit_particles.particle_type.star_new");
   private final ModeSetting.Value random = new ModeSetting.Value(this.particleType, "modules.settings.hit_particles.particle_type.random");
   private final ModeSetting colorMode = new ModeSetting(this, "modules.settings.hit_particles.color_mode");
   private final ModeSetting.Value themeColor = new ModeSetting.Value(this.colorMode, "modules.settings.hit_particles.color_mode.theme").select();
   private final ModeSetting.Value rainbowColor = new ModeSetting.Value(this.colorMode, "modules.settings.hit_particles.color_mode.rainbow");
