...
import moscow.elegant.systems.event.impl.game.EntityDeathEvent;
...
import moscow.elegant.utility.sounds.ClientSoundInstance;
...
public class KillEffects extends BaseModule {
   ...
   private final ModeSetting.Value randomMode = new ModeSetting.Value(this.soundType, "modules.settings.kill_effects.sound_type.random").select();
