...
import moscow.elegant.utility.render.CrystalRenderer;
...
public class TargetESP extends BaseModule {
   ...
   private void renderChainCylinder(MatrixStack stack, double x, double y, double z, float offsetAngle) {
      ...
      float radius = this.prevTarget.getWidth() * 0.65F * this.size.getCurrentValue();
      ...
      float chainHeight = this.prevTarget.getHeight() * 1.05F * this.size.getCurrentValue();
