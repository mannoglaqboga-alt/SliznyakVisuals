...
import moscow.elegant.utility.particle.ParticleUtil;
...
public class ParticleEffects extends BaseModule {
   ...
   private final ModeSetting.Value heartMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.heart");
   private final ModeSetting.Value starMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.star").select();
   private final ModeSetting.Value snowMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.snow");
   private final ModeSetting.Value bloomMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.bloom");
   private final ModeSetting.Value dollarMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.dollar");
   private final ModeSetting.Value triangleMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.triangle");
   private final ModeSetting.Value sakuraMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.sakura");
   private final ModeSetting.Value geminiMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.gemini");
   private final ModeSetting.Value simsMode = new ModeSetting.Value(this.particleType, "modules.settings.particle_effects.particle_type.sims");
