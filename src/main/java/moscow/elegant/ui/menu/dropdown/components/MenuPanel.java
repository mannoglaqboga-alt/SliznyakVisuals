package moscow.elegant.ui.menu.dropdown.components;
...
public class MenuPanel extends CustomComponent implements IScaledResolution {
   ...
   protected void renderComponent(UIContext context) {
      ...
      // Config UI moved to main DropDownScreen right side as button + panel
   ...
   public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
      if (this.selectedModuleComponent != null) {
         ...
         // (config UI moved to DropDownScreen right-side button/panel)
         ...
         if (GuiUtility.isHovered((double)this.x, (double)y, (double)this.width, 20.0, mouseX, mouseY) && button == MouseButton.LEFT) {
            this.setSelectedModuleComponent(null);
   ...
   public void setSelectedModuleComponent(ModuleComponent selectedModuleComponent) {
      ...
      moscow.elegant.ui.menu.dropdown.DropDownScreen ds = null;
      if (elegant.getInstance().getMenuScreen() instanceof moscow.elegant.ui.menu.dropdown.DropDownScreen drop) {
         ds = drop;
      }
      if (ds != null) {
         if (selectedModuleComponent != null) {
            ds.rememberOpened(this.category, selectedModuleComponent.getModule());
         } else {
            ds.forgetOpened(this.category);
         }
      }
   }
}
